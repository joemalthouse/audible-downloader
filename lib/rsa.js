...
/**
 * Sign `dataString` with the supplied RSA private key using RSASSA-PKCS1-v1_5
 * (SHA-256). Accepts both PKCS#1 (`BEGIN RSA PRIVATE KEY`) and PKCS#8
 * (`BEGIN PRIVATE KEY`) PEM forms. The imported CryptoKey is cached by SHA-256
 * fingerprint of the PEM so repeat calls reuse the key handle.
 *
 * @param {string} privateKeyPemOrBase64
 * @param {string} dataString
 * @returns {Promise<string>} base64 (standard) encoded signature
 */
